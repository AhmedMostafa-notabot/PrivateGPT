...
with st.form('my_form'):
  ...
  if uploaded_file_pdf is not None:
    ...
    pdf_qa = ConversationalRetrievalChain.from_llm(OpenAI(temperature=0.4,model_name='gpt-3.5-turbo-16k') , vectordb.as_retriever(search_type='similarity',search_kwargs={"k":5}),top_k_docs_for_context=5,chain_type="map_reduce")
  else:
    try:
