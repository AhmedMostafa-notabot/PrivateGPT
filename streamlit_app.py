...
openai_api_key = st.sidebar.text_input('First Insert OpenAI API Key',type="password")
uploaded_file_pdf = st.sidebar.file_uploader("Second Upload Documents",type=["pdf","docx","doc"],accept_multiple_files=True)
