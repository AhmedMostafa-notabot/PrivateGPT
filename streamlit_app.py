...
with st.form('my_form'):
  ...
  if uploaded_file_pdf is not None:
    ...
    chain = load_summarize_chain(llm=OpenAI(temperature=0,model_name='gpt-3.5-turbo-16k',frequency_penalty=1,presence_penalty=0, max_tokens=256), chain_type="refine", return_intermediate_steps=True)
